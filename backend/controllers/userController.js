...
exports.getUserDetails = async (req, res, next) => {
  try {
    ...
    return await res
      .status(200)
      .send({ success: false, message: "Please Login", error: error.message });
  }
};
...
exports.bookFlight = async (req, res, next) => {
  try {
    ...
    await res
      .status(200)
      .send({ success: true, message: "Flight Booked Successfully !!", user });
  } catch (error) {
...
exports.bookTour = async (req, res, next) => {
  try {
    ...
    await res
      .status(200)
      .send({ success: true, message: "Tour Booked Successfully !!", user });
  } catch (error) {
    await res.status(400).send({ success: false, message: error.message });
  }
};
